...
const tableauProduits = [
    {
        ...
        nom: "Wind Flowers",
        prix: 110,
        description: "Une eau de parfum audacieuse et envoûtante. Notes chaudes de lavande, de fleur d’oranger et de musc. Parfait pour les femmes confiantes et passionnées",
        genre: "Femme",
        src: "parfum-1.jpg",
    },
    {
        ...
        nom: "Ivy Dubai",
        prix: 175,
        description: "Un parfum dandy, élégant et sophistiqué. Il mêle la lavande, la vanille et le musc, créant une fragrance intemporelle et réconfortante. Parfait pour les hommes qui apprécient la tradition et la qualité.",
        genre: "Homme",
        src: "parfum-2.jpg",
    },
    {
        ...
        prix: 90,
        description: "Un classique intemporel créé en 1966, il est l’un des parfums les plus vendus au pays. Sa recette simple et indémodable met en avant la bergamote, le citron, le basilic, la sauge et le romarin, avec des accords chyprés et épicés.",
        genre: "Homme",
        src: "parfum-3.jpg",
    },
    { 
        ...
        prix: 70,
        description: "Un parfum floral luxuriant. Mélange de jasmin, de tubéreuse et de gardénia. Évoque la beauté naturelle et la féminité",
        genre: "Femme",
        src: "parfum-4.jpg",
    },
    {
        ...
        prix: 120,
        description: "Un classique intemporel. Notes de rose, de jasmin et de magnolia. Élégant et sensuel, idéal pour les occasions spéciales",
        genre: "Femme",
        src: "parfum-5.jpg",
    },
]
...
function ajouteBordure(elementHTML){
    ...
    elementHTML.style.border = "1px solid black";
    elementHTML.style.padding = "5px";
}
